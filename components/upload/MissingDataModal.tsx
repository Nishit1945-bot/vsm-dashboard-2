// components/upload/MissingDataModal.tsx
'use client';
...
// Remove this import - we'll define it locally
// import { MissingFieldAnalysis } from '@/lib/csv-parser';
...
interface MissingDataModalProps {
  ...
  onComplete: (providedData: Record<string, any>) => void;
  onUseDefaults: () => void;
  onCancel: () => void;
}
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-xs text-blue-800">
                ...
                <p>{getFieldDescription(currentField.field)}</p>
              </div>
            </div>
          </div>
        </div>
